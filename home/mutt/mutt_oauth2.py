#!/usr/bin/env python3
#
# This is the README file for this code: https://gitlab.com/muttmua/mutt/-/blob/master/contrib/mutt_oauth2.py.README
# This is where I got the code from: https://gitlab.com/muttmua/mutt/-/blob/master/contrib/mutt_oauth2.py
#
...
registrations = {
    'google': {
        ...
        'client_id': '{{ gmail.google_client_id }}',
        'client_secret': '{{ gmail.google_client_secret }}',
    },
    'microsoft': {
