...
# xrandr --output eDP-1 --primary --mode 2560x1600 --pos 0x900 --rotate normal --scale .75x.75
xrandr --output eDP-1 --primary --mode 2560x1600 --pos 0x900 --rotate normal --scale 1x1
