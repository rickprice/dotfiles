...
# TOKEN is set by Dotter
TOKEN = "{{ medium.medium_token }}"
...
def read_file(filepath):
    """
    reads file from input filepath and returns a dict with the file content and
    contentFormat for the publish payload
    """
